...
(function() {
  var ajson, app_version, check, clog, cltags, compile, http, isPortTaken, jjson, lookup, net, npm, sjson, startLiveReload, tags, tinylr, watcher;
          ...
          return http.get(npm + p.name + "/latest", function(res) {
            ...
            return res.on("end", function() {
              ...
              if (data.version !== p.version) {
                return console.log("There is a newer version of " + p.name + " available please run `\x1B[0;1mnpm install -g jeet\x1B[0;0m` before creating a new project");
              } else {
                return lookup();
              }
            });
